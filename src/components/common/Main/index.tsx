...
import { ImageGame, ImageGift, ImageShadow, ImageShop } from "./_assets";
...
export const MainLayer = () => {
  ...
  return (
    <div className={style.layer}>
      ...
      >
        <motion.div variants={cardShop}>
          <Image src={ImageShop} alt="shop" />
        </motion.div>
      </motion.div>

      <motion.div
        className={classNames(style.imageContainer, style.game)}
        initial="offscreen"
        whileInView="onscreen"
        viewport={{ once: true, amount: 0.8 }}
      >
        <motion.div variants={cardGame}>
          <Image src={ImageGame} alt="game" />
        </motion.div>
      </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true, amount: 0.8 }}
      >
        <motion.div variants={imageGift}>
          <Image src={ImageGift} alt="gift" />
        </motion.div>
      </motion.div>
    </div>
  );
